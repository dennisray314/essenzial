...
function wplc_pro_get_departments_table(){
    ...
    $content .= 		"</tr>";
  	...
  	if($results){
  		...
  		$content .= "<tr><td>".__("No Deparments Found...", "wp-livechat")."</td><td></td><td></td></tr>";
  	}
...
function wplc_pro_get_add_department_content(){
    ...
    $content .= 	"<tr>";
    $content .= 		"<td></td>";
    $content .= 		"<td><input class='button button-primary' type='submit' name='wplc_department_submit' value='".__($wplc_submit_label, "wp-livechat")."'> <a href='".admin_url()."admin.php?page=wplc-pro-departments"."' class='button'>".__("Close", "wp-livechat")."</a></td>";
    $content .= 	"</tr>";
