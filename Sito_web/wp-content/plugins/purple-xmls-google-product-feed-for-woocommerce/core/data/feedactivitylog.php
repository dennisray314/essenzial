...
class PFeedActivityLog
{
    ...
    private static function addNewFeedData($category, $remote_category, $file_name, $file_path, $providerName, $productCount, $miinto_country_code = null)
    {
        ...
        PFeedActivityLog::$addNewFeedData($category, $remote_category, $file_name, $file_path, $providerName, $productCount, $miinto_country_code);
    }
    ...
    {
        PFeedActivityLog::addNewFeedDataJ($category, $remote_category, $file_name, $file_path, $providerName, $productCount);
    }
    ...
    private static function addNewFeedDataW($category, $remote_category, $file_name, $file_path, $providerName, $productCount, $miinto_country_code = null)
    {
        ...
        if ($pfcore->feedType == 1) {
            $feed_type = 1;
            $sql = "SELECT * from {$wpdb->prefix}cpf_custom_products";
    ...
    private static function feedDataToIDJH($file_name, $providerName)
    {
        ...
        return PFeedActivityLog::feedDataToIDJ($file_name, $providerName);
    ...
    public static function updateFeedList($category, $remote_category, $file_name, $file_path, $providerName, $productCount, $miinto_country_code = null)
    {
        ...
        if ($id == -1)
            ...
            PFeedActivityLog::updateFeedData($id, $category, $remote_category, $file_name, $file_path, $providerName, $productCount, $miinto_country_code);
    }
    ...
    private static function updateFeedDataJH($id, $category, $remote_category, $file_name, $file_path, $providerName, $productCount)
    {
        ...
        PFeedActivityLog::updateFeedDataJ($id, $category, $remote_category, $file_name, $file_path, $providerName, $productCount);
