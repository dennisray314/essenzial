                    ...
                    <span onclick="resetSubmitForm();" class="reset_cpf_cpfcustomfeed"><img src="' . IMAGE_PATH . '/reset.png" style="vertical-align:middle;">Reset Search</span>
                            <div class="form-search">
                                <div class="searchrow">
                                    ...
                                    <div class="col-hide">
                                        <input name="hideoutofstock" type="checkbox" id="out_of_stock_checkbox">Hide Out Of Stock products ?
                                    </div>
                            ...
                            <tfoot>
                                  <th colspan="3" id="bulk-action" style="display:none;">
                                        ...
                                        <span style="display:none;"> <input type="button" id="doaction2" class="button-primary action apply_btn" value="Apply" onclick="cpf_apply_action(this)">
                                           ...
                                           <a href="#submitpost" <span class="move-search-products"><input class="button-primary" type="button" title="Click here to move the selected product list to SELECTED PRODUCTS section.SELECTED PRODUCT section prepare your search result to be included in your feed." id="cpf_move_selected" value="Move Selected" onclick ="moveSelected(this) ;" />
                                        </span>
...
<div class="clear"></div>
                ...
                <tbody>
                    <tr valign="top">
                        ...
                        <td class="forminp" style="float:left;">
                            <input style="width: 240px;" type="search" name="categoryDisplayText" class="text_big merchant-category" id="remotecategoryDisplayText" onclick="return checkPlaceholdervalue(this);" onkeyup="doFetchCategory_timed_custom(' . "'{$this->service_name}'" . ',this)" value="" autocomplete="off" placeholder="Start typing merchant category..." MN>
         ...
         <div id="cpf_advance_command">
                <div id="cpf_advance_section" style="display: none;">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp" style="float:left">
                            <input type="search" style="width: 240px;" name="feed_filename" id="feed_filename" class="text_big" value="' . "$this->initial_filename" . '" autocomplete="off" placeholder="Enter file name">
                        </td>
                    </tr>
                    <tr>
    ...
    public function mainDialog($source_feed = null, $feed_type = null)
    {
        ...
        if ($source_feed == null) {
            ...
            $this->miintobrandlocalcat       = $source_feed->local_category;
