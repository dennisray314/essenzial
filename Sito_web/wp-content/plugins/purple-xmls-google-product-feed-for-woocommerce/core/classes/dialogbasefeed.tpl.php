<?php global $pfcore;
if(isset($_REQUEST['feed_type'])&&isset($_REQUEST['action']))
{
    if($_REQUEST['action']=='edit' && $_REQUEST['feed_type']==1){
?>
            ...
            <?php if ($this->service_name !== "Etsy") { ?>
                <div class="postbox">
                    ...
                    <div class="inside export-target">
                        ...
                        <div id="custom-feed-div-kmpxr" <?php if ($_REQUEST['feed_type'] == 1 && $_REQUEST['id'] != '') {
                        ...
                        <div class="">
                            ...
                            <div class='amazon-template-table'>
                                ...
                                <a class="button-primary" target="_blank"
                                   href="<?php echo $this->plugin_link; ?>">Get <?php echo $this->service_name; ?>
                                    Plugin Here
                                </a>
...
<?php if ($_REQUEST['feed_type'] == 1 && $_REQUEST['id'] != '') { ?>
