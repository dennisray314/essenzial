<?php 
/*
 * Handles the transferring of a chat - Puff puff pass
*/
...
add_action("wplc_hook_change_status_on_answer","wplc_pro_clear_transfer_request_if_set",10,1);
/**
 * Unsets the transfer request once it is answered
 *
 * @return int (response code)
*/
function wplc_pro_clear_transfer_request_if_set($get_data) {
	global $wpdb;
